  ...
  fileFilter: (req, file, cb) => {
    ...
    if (ALLOWED_MIME_TYPES.includes(file.mimetype)) {
      ...
      const allowedExtensions = [
        // Images
        ".jpg", ".jpeg", ".png", ".gif", ".webp", ".svg", ".bmp", ".tiff", ".tif", ".ico", ".psd",
        // Videos
        ".mp4", ".mpeg", ".mov", ".avi", ".wmv", ".webm", ".flv", ".3gp", ".mkv", ".m4v", ".ts", ".mts", ".m2ts", ".mxf", ".asf", ".ogv",
        // Audio
        ".mp3", ".wav", ".aac", ".m4a", ".ogg", ".flac", ".aiff", ".aif", ".wma", ".ape", ".opus", ".ra",
        // Documents
        ".pdf", ".doc", ".docx", ".odt", ".xls", ".xlsx", ".ods", ".ppt", ".pptx", ".odp", ".txt", ".csv", ".rtf",
        // Archives
