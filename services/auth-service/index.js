...
const requiredEnvVars = ["DB_SERVER", "DB_NAME", "DB_USER", "DB_PASSWORD", "JWT_SECRET", "FRONTEND_URL"];
...
app.get("/health", async (req, res) => {
  try {
    ...
    res.status(500).json({ success: false, service: "auth-service", status: "ERROR", error: "Database connection failed" });
  }
});
