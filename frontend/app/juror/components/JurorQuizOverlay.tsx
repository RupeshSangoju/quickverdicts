...
// Minimum seconds the juror must spend on the presentation before continuing.
// This approximates "scrolled to the end" for a cross-origin iframe.
const REQUIRED_SECONDS = 90;

export default function JurorQuizOverlay({
  open,
  onClose,
  onFinish,
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-[#0C2D57] to-[#132c54] flex-shrink-0">
          <div>
            <h2 className="text-lg font-bold text-white">Juror Orientation</h2>
        ...
        <div className="flex-1 overflow-hidden min-h-0">
          <iframe
            ...
            scrolling="no"
            allowFullScreen
            style={{ border: "none", display: "block", width: "100%", height: "100%", minHeight: "420px" }}
          />
        </div>
