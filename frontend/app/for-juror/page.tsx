      ...
      >
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-md p-6 border border-gray-200">
            ...
            <p className="text-sm text-gray-600 mt-2 leading-relaxed">
Browse available cases in your area and choose the ones that fit your schedule. Our dedicated Open Cases list makes it easy to find and apply for paid jury opportunities with just a few clicks.
            </p>
          </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start">
                  <div>
                    ...
                    <p className="text-gray-600">We'll notify you when a case opens in your county. You can also browse active cases under Open Cases.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div>
